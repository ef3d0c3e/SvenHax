...
#define __CSTRUCTS_CVALUES(__name, __visibility, __N, __tp, __id, __off) \
	constexpr static inline unsigned long __id = __off;
...
#define __CSTRUCTS_IF_SZ_FN(__name, __visibility, __N, __tp, __id, __off) \
	else if constexpr (i == __N)               \
	{                                          \
		return sizeof(void*);                  \
	}
#define __CSTRUCTS_MEMBERS(__name, __visibility, __N, __tp, __id, __off) \
		...
		__tp __id;
#define __CSTRUCTS_MEMBERS_FN(__name, __visibility, __N, __tp, __id, __off) \
		struct { char8_t data[__CSTRUCTS_CONCAT(__name, __offsets)::getPadding<__N>()]; } __CSTRUCTS_CONCAT(__pad_, __id); \
		__tp;
...
#define CSTRUCTS_MEMBERS(__name, __visibility, ...)                                                         \
	...
	private:                                                                                                \
		...
		using __cref = unsigned long;                                                                       \
		using __ref = unsigned long&;                                                                       \
		using __crv = const unsigned long&&;                                                                \
...
#define CSTRUCTS_MEMBERS_FN(__name, __visibility, ...)                                                      \
	struct __CSTRUCTS_CONCAT(__name, __offsets)                                                             \
	{                                                                                                       \
	private:                                                                                                \
		using __type = unsigned long;                                                                       \
	...
	public:                                                                                                 \
		...
		{                                                                                                   \
			...
			__CENUM_EXPAND(__CENUM_EVAL(__CSTRUCTS_MAP(__counter2, __name, __visibility, __CSTRUCTS_IF_SZ_FN, __VA_ARGS__))) \
			else                                                                                            \
			{                                                                                               \
				[]<bool v = false>()                                                                        \
				{                                                                                           \
	...
	__visibility:                                                                                           \
		...
		__CENUM_EXPAND(__CENUM_EVAL(__CSTRUCTS_MAP(__counter_base, __name, __visibility, __CSTRUCTS_MEMBERS_FN, __VA_ARGS__)))
