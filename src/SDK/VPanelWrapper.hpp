#ifndef SDK_VPANELWRAPPER_HPP
#define SDK_VPANELWRAPPER_HPP

#include "IBaseInterface.hpp"
#include "CEngineVGui.hpp" // VPANEL
#include "CSchemeManager.hpp" // HSCHEME
class IClientPanel;
class Panel;
class SurfacePlat;
class IKeyValues;

class VPanelWrapper : public IBaseInterface
{
public:
	...
	virtual void SendMessage(VPANEL vguiPanel, IKeyValues *params, VPANEL ifromPanel) = 0;
	...
	virtual bool RequestInfo(VPANEL vguiPanel, IKeyValues *outputData) = 0;
